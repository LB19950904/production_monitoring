...
public class AgentPackageConstructor extends AbstractPackageConstructor {
    ...
    public DockerPackage structureDockerPackage(Docker docker) throws NetException {
        ...
        // 构造基础请求包数据
        this.structureBaseRequestPackage(dockerPackage, null);
        // 设置docker信息
        dockerPackage.setDocker(docker);
        dockerPackage.setRate(ConfigLoader.getMonitoringProperties().getDockerInfo().getRate());
