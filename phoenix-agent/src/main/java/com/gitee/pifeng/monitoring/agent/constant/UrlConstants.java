...
public final class UrlConstants {
     ...
     * 发送异常包URL地址
     */
    public static final String EXCEPTION_URL = ROOT_URI + "/exception/accept-exception-package";
     ...
     * 发送网络设备信息包URL地址
     */
    public static final String NETWORK_DEVICE_URL = ROOT_URI + "/network-device/accept-network-device-package";
     ...
     * 测试网络设备连通性URL地址
     */
    public static final String TEST_MONITOR_NETWORK_DEVICE_URL = ROOT_URI + "/network-device/test-monitor-network-device";
     ...
     * 配置Java线程池URL地址
     */
    public static final String SET_INSTANCE_JAVA_THREAD_POOL_URL = ROOT_URI + "/instance/set-instance-java-thread-pool";
