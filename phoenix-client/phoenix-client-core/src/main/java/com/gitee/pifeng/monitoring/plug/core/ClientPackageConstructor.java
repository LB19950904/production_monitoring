...
public class ClientPackageConstructor extends AbstractPackageConstructor {
    ...
    public ExceptionPackage structureExceptionPackage(ExceptionInfo exceptionInfo, boolean alarmEnable) throws NetException {
        ...
        // 构造基础请求包数据
        this.structureBaseRequestPackage(exceptionPackage, null);
        // 设置异常信息
        exceptionPackage.setExceptionInfo(exceptionInfo);
        // 是否开启异常信息告警
        exceptionPackage.setAlarmEnable(alarmEnable);
    ...
    public HeartbeatPackage structureHeartbeatPackage() throws NetException {
        ...
        // 是否收集线程池指标
        heartbeatPackage.setCollectThreadPoolMetrics(ConfigLoader.getMonitoringProperties().getJavaThreadPoolInfo().getEnable());
    ...
    public NetworkDevicePackage structureNetworkDevicePackage(NetworkDevice networkDevice) throws NetException {
        NetworkDevicePackage networkDevicePackage = new NetworkDevicePackage();
        // 构造基础请求包数据
        this.structureBaseRequestPackage(networkDevicePackage, null);
        // 设置网络设备信息
        networkDevicePackage.setNetworkDevice(networkDevice);
        networkDevicePackage.setRate(ConfigLoader.getMonitoringProperties().getNetworkDeviceInfo().getRate());
        return networkDevicePackage;
    }
    ...
    public JavaThreadPoolPackage structureJavaThreadPoolPackage(JavaThreadPool javaThreadPool) throws NetException {
        JavaThreadPoolPackage javaThreadPoolPackage = new JavaThreadPoolPackage();
        // 构造基础请求包数据
        this.structureBaseRequestPackage(javaThreadPoolPackage, null);
        // 设置Java线程池信息
        javaThreadPoolPackage.setJavaThreadPool(javaThreadPool);
        javaThreadPoolPackage.setRate(ConfigLoader.getMonitoringProperties().getJavaThreadPoolInfo().getRate());
        return javaThreadPoolPackage;
    }
