...
public class NetworkDeviceUtilsTest {
    ...
    public void testDiscoverDevices() {
        ...
        List<String> snmpConnectionCommunities = Collections.singletonList(SnmpDefaultConstants.DEFAULT_COMMUNITY_STRING);
        Map<String, LinkedHashMap<String, String>> map = NetworkDeviceUtils.discoverDevices(ipAddress, netmask, snmpConnectionCommunities);
