...
public class MonitoringProperties implements ISuperBean {
     ...
     * 网络设备信息属性
     */
    private MonitoringNetworkDeviceInfoProperties networkDeviceInfo;
     ...
     * Java线程池信息属性
     */
    private MonitoringJavaThreadPoolInfoProperties javaThreadPoolInfo;

    /**
     * Docker信息属性
     */
    private MonitoringDockerInfoProperties dockerInfo;

    /**
     * Arthas属性
     */
    private MonitoringArthasProperties arthas;
