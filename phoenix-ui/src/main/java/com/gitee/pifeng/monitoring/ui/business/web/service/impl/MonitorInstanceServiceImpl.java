...
public class MonitorInstanceServiceImpl extends ServiceImpl<IMonitorInstanceDao, MonitorInstance> implements IMonitorInstanceService {
     ...
     */
    @Autowired
    private IMonitorJavaThreadPoolDao monitorJavaThreadPoolDao;
    ...
    public LayUiAdminResultVo deleteMonitorInstance(List<MonitorInstanceVo> monitorInstanceVos) {
        ...
        // java线程池信息表
        LambdaUpdateWrapper<MonitorJavaThreadPool> monitorJavaThreadPoolLambdaUpdateWrapper = new LambdaUpdateWrapper<>();
        monitorJavaThreadPoolLambdaUpdateWrapper.in(MonitorJavaThreadPool::getInstanceId, instanceIds);
        this.monitorJavaThreadPoolDao.delete(monitorJavaThreadPoolLambdaUpdateWrapper);
        // java线程池历史记录表
        LambdaUpdateWrapper<MonitorJavaThreadPoolHistory> monitorJavaThreadPoolHistoryLambdaUpdateWrapper = new LambdaUpdateWrapper<>();
        monitorJavaThreadPoolHistoryLambdaUpdateWrapper.in(MonitorJavaThreadPoolHistory::getInstanceId, instanceIds);
        this.monitorJavaThreadPoolHistoryDao.delete(monitorJavaThreadPoolHistoryLambdaUpdateWrapper);
        // 应用程序
    ...
    public LayUiAdminResultVo clearMonitorInstanceHistory(String instanceId, String time) {
        ...
        this.monitorJvmMemoryHistoryDao.delete(jvmMemoryHistoryLambdaUpdateWrapper);
        // 清理java线程池历史记录表
        LambdaUpdateWrapper<MonitorJavaThreadPoolHistory> javaThreadPoolHistoryLambdaUpdateWrapper = new LambdaUpdateWrapper<>();
        javaThreadPoolHistoryLambdaUpdateWrapper.eq(MonitorJavaThreadPoolHistory::getInstanceId, instanceId);
        javaThreadPoolHistoryLambdaUpdateWrapper.lt(MonitorJavaThreadPoolHistory::getInsertTime, clearTime);
        this.monitorJavaThreadPoolHistoryDao.delete(javaThreadPoolHistoryLambdaUpdateWrapper);
        return LayUiAdminResultVo.ok(WebResponseConstants.SUCCESS);
    }
