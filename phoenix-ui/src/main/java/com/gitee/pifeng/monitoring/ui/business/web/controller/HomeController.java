...
public class HomeController extends BaseController {
    ...
    public ModelAndView home() {
        ...
        HomeDockerVo homeDockerVo = this.monitorDockerService.getHomeDockerInfo();
        mv.addObject("homeDockerVo", homeDockerVo);
        HomeNetworkDeviceVo homeNetworkDeviceVo = this.monitorNetworkDeviceService.getHomeNetworkDeviceInfo();
        mv.addObject("homeNetworkDeviceVo", homeNetworkDeviceVo);
        return mv;
    }
    ...
    public LayUiAdminResultVo getSummaryInfo() {
        ...
        map.put("homeDockerVo", homeDockerVo);
        map.put("homeNetworkDeviceVo", homeNetworkDeviceVo);
