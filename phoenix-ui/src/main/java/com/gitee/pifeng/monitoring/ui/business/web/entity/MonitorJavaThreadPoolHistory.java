...
@TableName("MONITOR_JAVA_THREAD_POOL_HISTORY")
@Schema(description = "MonitorJavaThreadPoolHistory对象")
public class MonitorJavaThreadPoolHistory implements Serializable {
