...
public class MonitorConfigServiceImpl extends ServiceImpl<IMonitorConfigDao, MonitorConfig> implements IMonitorConfigService {
    ...
    public MonitorConfigPageFormVo getMonitorConfigPageFormInfo() {
        ...
        monitorConfigPageFormVo.setFailureAlarmCount(properties.getAlarmProperties().getFailureAlarmCount());
        monitorConfigPageFormVo.setRecoveryAlarmCount(properties.getAlarmProperties().getRecoveryAlarmCount());
        ...
        monitorConfigPageFormVo.setAlarmDingtalkSecret(properties.getAlarmProperties().getDingtalkProperties().getSecret());
        monitorConfigPageFormVo.setAlarmDingtalkWebhook(properties.getAlarmProperties().getDingtalkProperties().getWebhook());
        monitorConfigPageFormVo.setAlarmDingtalkAtAllEnable(properties.getAlarmProperties().getDingtalkProperties().getIsAtAll() ? 1 : 0);
        monitorConfigPageFormVo.setAlarmDingtalkPhoneNumbers(ArrayUtil.join(properties.getAlarmProperties().getDingtalkProperties().getPhoneNumbers(), ";"));
        monitorConfigPageFormVo.setAlarmEnterpriseWechatWebhook(properties.getAlarmProperties().getEnterpriseWechatProperties().getWebhook());
        monitorConfigPageFormVo.setAlarmEnterpriseWechatAtAllEnable(properties.getAlarmProperties().getEnterpriseWechatProperties().getIsAtAll() ? 1 : 0);
        monitorConfigPageFormVo.setAlarmEnterpriseWechatPhoneNumbers(ArrayUtil.join(properties.getAlarmProperties().getEnterpriseWechatProperties().getPhoneNumbers(), ";"));
        monitorConfigPageFormVo.setAlarmFeishuSecret(properties.getAlarmProperties().getFeishuProperties().getSecret());
        monitorConfigPageFormVo.setAlarmFeishuWebhook(properties.getAlarmProperties().getFeishuProperties().getWebhook());
        monitorConfigPageFormVo.setAlarmFeishuAtAllEnable(properties.getAlarmProperties().getFeishuProperties().getIsAtAll() ? 1 : 0);
        monitorConfigPageFormVo.setAlarmFeishuUserIds(ArrayUtil.join(properties.getAlarmProperties().getFeishuProperties().getUserIds(), ";"));
        ...
        monitorConfigPageFormVo.setDbSlowSqlEnable(properties.getDbProperties().getDbSlowSqlProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setDbSlowSqlAlarmEnable(properties.getDbProperties().getDbSlowSqlProperties().isAlarmEnable() ? 1 : 0);
        monitorConfigPageFormVo.setDbSlowSqlJudgeExecTime(properties.getDbProperties().getDbSlowSqlProperties().getJudgeExecTime());
        monitorConfigPageFormVo.setDbSlowSqlLevel(properties.getDbProperties().getDbSlowSqlProperties().getLevelEnum().name());
        monitorConfigPageFormVo.setDockerEnable(properties.getDockerProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setDockerStatusEnable(properties.getDockerProperties().getDockerStatusProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setDockerStatusAlarmEnable(properties.getDockerProperties().getDockerStatusProperties().isAlarmEnable() ? 1 : 0);
        ...
        monitorConfigPageFormVo.setInstanceThreadPoolEnable(properties.getInstanceProperties().getInstanceThreadPoolProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setInstanceThreadPoolAlarmEnable(properties.getInstanceProperties().getInstanceThreadPoolProperties().isAlarmEnable() ? 1 : 0);
        monitorConfigPageFormVo.setNetworkDeviceEnable(properties.getNetworkDeviceProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setNetworkDeviceStatusEnable(properties.getNetworkDeviceProperties().getNetworkDeviceStatusProperties().isEnable() ? 1 : 0);
        monitorConfigPageFormVo.setNetworkDeviceStatusAlarmEnable(properties.getNetworkDeviceProperties().getNetworkDeviceStatusProperties().isAlarmEnable() ? 1 : 0);
    ...
    public LayUiAdminResultVo update(MonitorConfigPageFormVo monitorConfigPageFormVo) throws NetException, SigarException {
        ...
        // 告警钉钉配置属性
        MonitoringAlarmDingtalkProperties monitoringAlarmDingtalkProperties = new MonitoringAlarmDingtalkProperties();
        monitoringAlarmDingtalkProperties.setSecret(monitorConfigPageFormVo.getAlarmDingtalkSecret());
        monitoringAlarmDingtalkProperties.setWebhook(monitorConfigPageFormVo.getAlarmDingtalkWebhook());
        monitoringAlarmDingtalkProperties.setIsAtAll(monitorConfigPageFormVo.getAlarmDingtalkAtAllEnable() == 1);
        monitoringAlarmDingtalkProperties.setPhoneNumbers(StrUtil.splitToArray(monitorConfigPageFormVo.getAlarmDingtalkPhoneNumbers(), ';'));
        // 告警企业微信配置属性
        MonitoringAlarmEnterpriseWechatProperties monitoringAlarmEnterpriseWechatProperties = new MonitoringAlarmEnterpriseWechatProperties();
        monitoringAlarmEnterpriseWechatProperties.setWebhook(monitorConfigPageFormVo.getAlarmEnterpriseWechatWebhook());
        monitoringAlarmEnterpriseWechatProperties.setIsAtAll(monitorConfigPageFormVo.getAlarmEnterpriseWechatAtAllEnable() == 1);
        monitoringAlarmEnterpriseWechatProperties.setPhoneNumbers(StrUtil.splitToArray(monitorConfigPageFormVo.getAlarmEnterpriseWechatPhoneNumbers(), ';'));
        // 告警飞书配置属性
        MonitoringAlarmFeishuProperties monitoringAlarmFeishuProperties = new MonitoringAlarmFeishuProperties();
        monitoringAlarmFeishuProperties.setSecret(monitorConfigPageFormVo.getAlarmFeishuSecret());
        monitoringAlarmFeishuProperties.setWebhook(monitorConfigPageFormVo.getAlarmFeishuWebhook());
        monitoringAlarmFeishuProperties.setIsAtAll(monitorConfigPageFormVo.getAlarmFeishuAtAllEnable() == 1);
        monitoringAlarmFeishuProperties.setUserIds(StrUtil.splitToArray(monitorConfigPageFormVo.getAlarmFeishuUserIds(), ';'));
        // 告警配置属性
        ...
        monitoringAlarmProperties.setFailureAlarmCount(monitorConfigPageFormVo.getFailureAlarmCount());
        monitoringAlarmProperties.setRecoveryAlarmCount(monitorConfigPageFormVo.getRecoveryAlarmCount());
        ...
        monitoringAlarmProperties.setDingtalkProperties(monitoringAlarmDingtalkProperties);
        monitoringAlarmProperties.setEnterpriseWechatProperties(monitoringAlarmEnterpriseWechatProperties);
        monitoringAlarmProperties.setFeishuProperties(monitoringAlarmFeishuProperties);
        // 网络状态配置属性
        ...
        // 应用实例线程池配置属性
        MonitoringInstanceThreadPoolProperties monitoringInstanceThreadPoolProperties = new MonitoringInstanceThreadPoolProperties();
        monitoringInstanceThreadPoolProperties.setEnable(monitorConfigPageFormVo.getInstanceThreadPoolEnable() == 1);
        monitoringInstanceThreadPoolProperties.setAlarmEnable(monitorConfigPageFormVo.getInstanceThreadPoolAlarmEnable() == 1);
        // 应用实例配置属性
        ...
        monitoringInstanceProperties.setInstanceThreadPoolProperties(monitoringInstanceThreadPoolProperties);
        // 服务器状态配置属性
        ...
        // 数据库慢SQL配置属性
        MonitoringDbSlowSqlProperties monitoringDbSlowSqlProperties = new MonitoringDbSlowSqlProperties();
        monitoringDbSlowSqlProperties.setEnable(monitorConfigPageFormVo.getDbSlowSqlEnable() == 1);
        monitoringDbSlowSqlProperties.setAlarmEnable(monitorConfigPageFormVo.getDbSlowSqlAlarmEnable() == 1);
        monitoringDbSlowSqlProperties.setJudgeExecTime(monitorConfigPageFormVo.getDbSlowSqlJudgeExecTime());
        monitoringDbSlowSqlProperties.setLevelEnum(AlarmLevelEnums.str2Enum(monitorConfigPageFormVo.getDbSlowSqlLevel()));
        // 数据库配置
        ...
        monitoringDbProperties.setDbSlowSqlProperties(monitoringDbSlowSqlProperties);
        // docker服务状态配置属性
        MonitoringDockerStatusProperties monitoringDockerStatusProperties = new MonitoringDockerStatusProperties();
        monitoringDockerStatusProperties.setEnable(monitorConfigPageFormVo.getDockerStatusEnable() == 1);
        monitoringDockerStatusProperties.setAlarmEnable(monitorConfigPageFormVo.getDockerStatusAlarmEnable() == 1);
        // docker配置属性
        MonitoringDockerProperties monitoringDockerProperties = new MonitoringDockerProperties();
        monitoringDockerProperties.setEnable(monitorConfigPageFormVo.getDockerEnable() == 1);
        monitoringDockerProperties.setDockerStatusProperties(monitoringDockerStatusProperties);
        // 网络设备状态配置属性
        MonitoringNetworkDeviceStatusProperties monitoringNetworkDeviceStatusProperties = new MonitoringNetworkDeviceStatusProperties();
        monitoringNetworkDeviceStatusProperties.setEnable(monitorConfigPageFormVo.getNetworkDeviceStatusEnable() == 1);
        monitoringNetworkDeviceStatusProperties.setAlarmEnable(monitorConfigPageFormVo.getNetworkDeviceStatusAlarmEnable() == 1);
        // 网络设备配置属性
        MonitoringNetworkDeviceProperties monitoringNetworkDeviceProperties = new MonitoringNetworkDeviceProperties();
        monitoringNetworkDeviceProperties.setEnable(monitorConfigPageFormVo.getNetworkDeviceEnable() == 1);
        monitoringNetworkDeviceProperties.setNetworkDeviceStatusProperties(monitoringNetworkDeviceStatusProperties);
        // 监控配置属性
        ...
        properties.setDockerProperties(monitoringDockerProperties);
        properties.setNetworkDeviceProperties(monitoringNetworkDeviceProperties);
        // 监控属性转json字符串
