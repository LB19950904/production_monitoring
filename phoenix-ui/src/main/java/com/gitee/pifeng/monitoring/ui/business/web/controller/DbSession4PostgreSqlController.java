 ...
 */
@Controller
@Tag(name = "数据库会话.PostgreSQL")
@RequestMapping("/db-session4postgresql")
public class DbSession4PostgreSqlController extends BaseController {
    ...
    public LayUiAdminResultVo getSessionList(@RequestParam(value = "current") Long current,
        ...
        Page<DbSession4PostgreSqlVo> page = this.dbSession4PostgreSqlService.getSessionList(current, size, id, user, host, db, command, state, info);
    ...
    public LayUiAdminResultVo destroySession(@RequestBody List<Long> sessionIds,
        ...
        return this.dbSession4PostgreSqlService.destroySession(sessionIds, id);
    }
