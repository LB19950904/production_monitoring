...
public class MonitorInstance implements Serializable {
    ...
    @Schema(description = "是否启用Arthas")
    @TableField("IS_ENABLE_ARTHAS")
    private Boolean isEnableArthas;

    @Schema(description = "是否收集VM指标")
    @TableField("IS_COLLECT_VM_METRICS")
    private Boolean isCollectVmMetrics;

    @Schema(description = "是否收集线程池指标")
    @TableField("IS_COLLECT_THREAD_POOL_METRICS")
    private Boolean isCollectThreadPoolMetrics;
