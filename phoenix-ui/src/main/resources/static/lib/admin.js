            ...
            v: "1.4.0 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                if (e.exitFullscreen) {
                    try {
                        ...
                        console.log('exitFullscreen error:', err);
                    }
                } else if (e.mozCancelFullScreen) {
                    try {
                        e.mozCancelFullScreen();
                    } catch (err) {
                        console.log('mozCancelFullScreen error:', err);
                    }
                } else if (e.webkitCancelFullScreen) {
                    try {
                        e.webkitCancelFullScreen();
                    } catch (err) {
                        console.log('webkitCancelFullScreen error:', err);
                    }
                } else if (e.msExitFullscreen) {
                    try {
                        e.msExitFullscreen();
                    } catch (err) {
                        console.log('msExitFullscreen error:', err);
                    }
                }
            }
        }, F = P.events = {
