                ...
                var r = function () {
                    ...
                    return e.prototype.activate = function (e) {
                        ...
                        if (e && this._terminal) {
                            ...
                            this._terminal.rows === e.rows && this._terminal.cols === e.cols || (t.renderer.clear(), this._terminal.resize(e.cols, e.rows))
                        }
                        ...
                        if (this._terminal && this._terminal.element && this._terminal.element.parentElement) {
                            ...
                            if (0 !== e.renderer.dimensions.actualCellWidth && 0 !== e.renderer.dimensions.actualCellHeight) {
                                ...
                                return {
                                    cols: Math.max(2, Math.floor(a / e.renderer.dimensions.actualCellWidth)),
                                    rows: Math.max(1, Math.floor(o / e.renderer.dimensions.actualCellHeight))
                                }
                            }
                        }
                    }, e
