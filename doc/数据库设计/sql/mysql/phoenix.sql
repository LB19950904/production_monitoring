...
-- ----------------------------
-- Table structure for MONITOR_DB_SLOW_SQL_MYSQL
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DB_SLOW_SQL_MYSQL`;
CREATE TABLE `MONITOR_DB_SLOW_SQL_MYSQL`
(
    `ID`                    bigint UNSIGNED                                               NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `DB_ID`                 bigint UNSIGNED                                               NOT NULL COMMENT '数据库表ID',
    `SESSION_ID`            bigint                                                        NULL DEFAULT NULL COMMENT '会话ID',
    `USER_NAME`             varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户',
    `HOST`                  varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主机',
    `DB_NAME`               varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据库名',
    `COMMAND`               varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '命令',
    `EXECUTION_TIME`        bigint                                                        NULL DEFAULT NULL COMMENT '执行时间（秒）',
    `STATE`                 varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '状态',
    `SQL_TEXT`              longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT 'SQL文本',
    `NORMALIZE_SQL_TEXT`    longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '格式标准化后的SQL文本',
    `PARAMETERIZE_SQL_TEXT` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '参数化处理后的SQL文本',
    `SQL_MD5_HEX`           varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'SQL MD5值',
    `THRESHOLD_TIME`        bigint                                                        NULL DEFAULT NULL COMMENT '判断阈值（秒）',
    `DETECT_TIME`           datetime                                                      NULL DEFAULT NULL COMMENT '检测时间',
    `INSERT_TIME`           datetime                                                      NULL DEFAULT NULL COMMENT '插入时间',
    `UPDATE_TIME`           datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    UNIQUE INDEX `UX_SQL_MD5_HEX` (`SQL_MD5_HEX`) USING BTREE COMMENT '索引_SQL的MD5值',
    INDEX `MONITOR_DB_SLOW_SQL_MYSQL_DB_FK` (`DB_ID`) USING BTREE COMMENT '索引_数据库表ID',
    CONSTRAINT `MONITOR_DB_SLOW_SQL_MYSQL_DB_FK` FOREIGN KEY (`DB_ID`) REFERENCES `MONITOR_DB` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'MySQL数据库慢SQL表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DB_SLOW_SQL_ORACLE
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DB_SLOW_SQL_ORACLE`;
CREATE TABLE `MONITOR_DB_SLOW_SQL_ORACLE`
(
    `ID`                    bigint UNSIGNED                                               NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `DB_ID`                 bigint UNSIGNED                                               NOT NULL COMMENT '数据库表ID',
    `SID`                   bigint                                                        NULL DEFAULT NULL COMMENT '会话ID',
    `SERIAL#`               bigint                                                        NULL DEFAULT NULL COMMENT '序列号',
    `USER_NAME`             varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户',
    `SCHEMA_NAME`           varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '模式',
    `SESSION_TYPE`          varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '会话类型',
    `STATE`                 varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '状态',
    `LOGON_TIME`            datetime                                                      NULL DEFAULT NULL COMMENT '登录时间',
    `MACHINE`               varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '机器',
    `OS_USER`               varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作系统用户',
    `PROGRAM`               varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '程序',
    `EVENT`                 varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件',
    `WAIT_TIME`             bigint                                                        NULL DEFAULT NULL COMMENT '等待时间（秒）',
    `LAST_CALL_ET`          bigint                                                        NULL DEFAULT NULL COMMENT 'SQL已执行时间（秒）',
    `SQL_TEXT`              longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT 'SQL文本',
    `NORMALIZE_SQL_TEXT`    longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '格式标准化后的SQL文本',
    `PARAMETERIZE_SQL_TEXT` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL COMMENT '参数化处理后的SQL文本',
    `SQL_MD5_HEX`           varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'SQL MD5值',
    ...
    PRIMARY KEY (`ID`) USING BTREE,
    UNIQUE INDEX `UX_SQL_MD5_HEX` (`SQL_MD5_HEX`) USING BTREE COMMENT '索引_SQL的MD5值',
    INDEX `MONITOR_DB_SLOW_SQL_ORACLE_DB_FK` (`DB_ID`) USING BTREE COMMENT '索引_数据库表ID',
    CONSTRAINT `MONITOR_DB_SLOW_SQL_ORACLE_DB_FK` FOREIGN KEY (`DB_ID`) REFERENCES `MONITOR_DB` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'Oracle数据库慢SQL表'
  ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for MONITOR_DOCKER
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER`;
CREATE TABLE `MONITOR_DOCKER`
(
    `ID`                   bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`            varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '服务器IP',
    `ARCHITECTURE`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '架构',
    `CONTAINERS`           int(4)                                                        NULL DEFAULT NULL COMMENT '容器数量',
    `CONTAINERS_STOPPED`   int(4)                                                        NULL DEFAULT NULL COMMENT '停止的容器数量',
    `CONTAINERS_PAUSED`    int(4)                                                        NULL DEFAULT NULL COMMENT '暂停的容器数量',
    `CONTAINERS_RUNNING`   int(4)                                                        NULL DEFAULT NULL COMMENT '运行中的容器数量',
    `IS_DEBUG`             varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否debug模式（0：否，1：是）',
    `DOCKER_ROOT_DIR`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'docker根目录',
    `IMAGES`               int(4)                                                        NULL DEFAULT NULL COMMENT '镜像数量',
    `KERNEL_VERSION`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '内核版本',
    `IS_MEMORY_LIMIT`      varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否限制内存大小（0：否，1：是）',
    `MEM_TOTAL`            bigint(20)                                                    NULL DEFAULT NULL COMMENT '内存总大小',
    `SERVER_VERSION`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '服务版本',
    `CPU_NUM`              int(4)                                                        NULL DEFAULT NULL COMMENT 'CPU核数',
    `EVENTS_LISTENER_NUM`  int(4)                                                        NULL DEFAULT NULL COMMENT '监听的事件数量',
    `RAW_VALUES`           text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '完整信息（Json字符串）',
    `IS_ONLINE`            varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT 'docker服务状态（0：离线，1：在线）',
    `IS_ENABLE_MONITOR`    varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否开启监控（0：不开启监控；1：开启监控）',
    `IS_ENABLE_ALARM`      varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否开启告警（0：不开启告警；1：开启告警）',
    `OFFLINE_COUNT`        int(8)                                                        NULL DEFAULT NULL COMMENT '离线次数',
    ...
    `MONITOR_ENV`          varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控环境',
    `MONITOR_GROUP`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控分组',
    `DOCKER_SUMMARY`       varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'docker摘要',
    `AGENT_COMM_CLIENT_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控代理通信客户端ID',
    `INSERT_TIME`          datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`          datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    UNIQUE INDEX `UX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
    INDEX `MONITOR_DOCKER_ENV_FK` (`MONITOR_ENV`) USING BTREE COMMENT '索引_监控环境',
    INDEX `MONITOR_DOCKER_GROUP_FK` (`MONITOR_GROUP`) USING BTREE COMMENT '索引_监控分组',
    CONSTRAINT `MONITOR_DOCKER_ENV_FK` FOREIGN KEY (`MONITOR_ENV`) REFERENCES `MONITOR_ENV` (`ENV_NAME`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `MONITOR_DOCKER_GROUP_FK` FOREIGN KEY (`MONITOR_GROUP`) REFERENCES `MONITOR_GROUP` (`GROUP_NAME`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker服务表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DOCKER_CONTAINER
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER_CONTAINER`;
CREATE TABLE `MONITOR_DOCKER_CONTAINER`
(
    `ID`               bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`        varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '服务器IP',
    ...
    `CONTAINER_PORTS`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '容器端口',
    `CONTAINER_LABELS` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '容器标识',
    `IMAGE_ID`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '镜像ID',
    `IMAGE_NAME`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '镜像名字',
    `COMMAND`          text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '命令',
    `CREATED`          datetime                                                      NULL DEFAULT NULL COMMENT '容器创建时间',
    `STATUS`           varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '容器状态',
    `INSERT_TIME`      datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`      datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
    INDEX `NX_CONTAINER_ID` (`CONTAINER_ID`) USING BTREE COMMENT '索引_容器ID',
    INDEX `NX_CONTAINER_NAME` (`CONTAINER_NAME`) USING BTREE COMMENT '索引_容器名',
    INDEX `NX_IMAGE_ID` (`IMAGE_ID`) USING BTREE COMMENT '索引_镜像ID'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker容器信息表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DOCKER_EVENT
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER_EVENT`;
CREATE TABLE `MONITOR_DOCKER_EVENT`
(
    `ID`              bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`       varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '服务器IP',
    `EVENT_STATUS`    varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件状态',
    `EVENT_ID`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件ID',
    `EVENT_FROM`      varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件来源',
    `EVENT_TYPE`      varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件类型',
    `EVENT_ACTION`    varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '事件动作',
    `EVENT_ATTRIBUTE` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '事件属性',
    `HAPPEN_TIME`     datetime                                                      NULL DEFAULT NULL COMMENT '事件发生时间',
    `INSERT_TIME`     datetime                                                      NULL DEFAULT NULL COMMENT '新增时间',
    `UPDATE_TIME`     datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
    INDEX `NX_EVENT_STATUS` (`EVENT_STATUS`) USING BTREE COMMENT '索引_事件状态',
    INDEX `NX_EVENT_FROM` (`EVENT_FROM`) USING BTREE COMMENT '索引_事件来源',
    INDEX `NX_EVENT_TYPE` (`EVENT_TYPE`) USING BTREE COMMENT '索引_事件类型',
    INDEX `NX_EVENT_ACTION` (`EVENT_ACTION`) USING BTREE COMMENT '索引_事件动作',
    INDEX `NX_INSERT_TIME` (`INSERT_TIME`) USING BTREE COMMENT '索引_插入时间'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker事件信息表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DOCKER_IMAGE
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER_IMAGE`;
CREATE TABLE `MONITOR_DOCKER_IMAGE`
(
    `ID`               bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`        varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '服务器IP',
    `IMAGE_ID`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '镜像ID',
    `IMAGE_REPOSITORY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '镜像仓库',
    `IMAGE_TAG`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '镜像标签',
    `IMAGE_SIZE`       bigint(20)                                                    NULL DEFAULT NULL COMMENT '镜像大小',
    `IMAGE_LABELS`     text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '镜像标识',
    `CREATED`          datetime                                                      NULL DEFAULT NULL COMMENT '镜像创建时间',
    `INSERT_TIME`      datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`      datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker镜像信息表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DOCKER_STATS
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER_STATS`;
CREATE TABLE `MONITOR_DOCKER_STATS`
(
    `ID`                   bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`            varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '服务器IP',
    `CONTAINER_ID`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '容器ID',
    `CONTAINER_NAME`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '容器名字',
    `CPU_UTILIZATION_RATE` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'CPU的使用情况',
    `MEN_USAGE_LIMIT`      varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '当前使用的内存和最大可以使用的内存',
    `MEN_UTILIZATION_RATE` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '内存使用情况',
    `NET_IO`               varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '网络 I/O 数据',
    `BLOCK_IO`             varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '磁盘 I/O 数据',
    `PIDS`                 varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'PID号',
    `INSERT_TIME`          datetime                                                      NULL DEFAULT NULL COMMENT '新增时间',
    `UPDATE_TIME`          datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker容器统计信息表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_DOCKER_STATS_HISTORY
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_DOCKER_STATS_HISTORY`;
CREATE TABLE `MONITOR_DOCKER_STATS_HISTORY`
(
    `ID`                   bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `SERVER_IP`            varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '服务器IP',
    `CONTAINER_ID`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '容器ID',
    `CONTAINER_NAME`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '容器名字',
    `CPU_UTILIZATION_RATE` double(16, 4)                                                 NULL DEFAULT NULL COMMENT 'CPU的使用情况',
    `MEN_USAGE`            bigint(20)                                                    NULL DEFAULT NULL COMMENT '当前使用的内存（单位：byte）',
    `MEN_LIMIT`            bigint(20)                                                    NULL DEFAULT NULL COMMENT '最大可以使用的内存（单位：byte）',
    `MEN_UTILIZATION_RATE` double(16, 4)                                                 NULL DEFAULT NULL COMMENT '内存使用情况',
    `NET_IN`               bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络 input 数据（单位：byte）',
    `NET_OUT`              bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络 output 数据（单位：byte）',
    `BLOCK_IN`             bigint(20)                                                    NULL DEFAULT NULL COMMENT '磁盘 input 数据（单位：byte）',
    `BLOCK_OUT`            bigint(20)                                                    NULL DEFAULT NULL COMMENT '磁盘 output 数据（单位：byte）',
    `PIDS`                 varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'PID号',
    `NET_IN_SPEED`         double(16, 4)                                                 NULL DEFAULT NULL COMMENT '网络 input 数据 速率，单位：B/s',
    `NET_OUT_SPEED`        double(16, 4)                                                 NULL DEFAULT NULL COMMENT '网络 output 数据 速率，单位：B/s',
    `BLOCK_IN_SPEED`       double(16, 4)                                                 NULL DEFAULT NULL COMMENT '磁盘 input 数据 速率，单位：B/s',
    `BLOCK_OUT_SPEED`      double(16, 4)                                                 NULL DEFAULT NULL COMMENT '磁盘 output 数据 速率，单位：B/s',
    `INSERT_TIME`          datetime                                                      NULL DEFAULT NULL COMMENT '新增时间',
    `UPDATE_TIME`          datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_SERVER_IP` (`SERVER_IP`) USING BTREE COMMENT '索引_服务器IP',
    INDEX `NX_CONTAINER_ID` (`CONTAINER_ID`) USING BTREE COMMENT '索引_容器ID',
    INDEX `NX_CONTAINER_NAME` (`CONTAINER_NAME`) USING BTREE COMMENT '索引_容器名',
    INDEX `NX_INSERT_TIME` (`INSERT_TIME`) USING BTREE COMMENT '索引_新增时间',
    INDEX `NX_UPDATE_TIME` (`UPDATE_TIME`) USING BTREE COMMENT '索引_更新时间'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'docker容器统计信息历史记录表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `IS_ENABLE_ARTHAS`               varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否启用Arthas',
    `IS_COLLECT_VM_METRICS`          varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否收集VM指标',
    `IS_COLLECT_THREAD_POOL_METRICS` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否收集线程池指标',
    `OFFLINE_COUNT`                  int(8)                                                        NULL DEFAULT NULL COMMENT '离线次数',
    `CONN_FREQUENCY`                 int(8)                                                        NOT NULL COMMENT '连接频率',
    `MONITOR_ENV`                    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控环境',
    `MONITOR_GROUP`                  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控分组',
...
-- ----------------------------
-- Table structure for MONITOR_JAVA_THREAD_POOL
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_JAVA_THREAD_POOL`;
CREATE TABLE `MONITOR_JAVA_THREAD_POOL`
(
    `ID`                              bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `INSTANCE_ID`                     varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '应用实例ID',
    `NAME`                            varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线程池名字',
    `ACTIVE_COUNT`                    int(8)                                                        NULL DEFAULT NULL COMMENT '活跃线程数',
    `COMPLETED_TASK_COUNT`            bigint(20)                                                    NULL DEFAULT NULL COMMENT '已完成的任务数',
    `TASK_COUNT`                      bigint(20)                                                    NULL DEFAULT NULL COMMENT '曾经接收过的总任务数',
    `LARGEST_POOL_SIZE`               int(8)                                                        NULL DEFAULT NULL COMMENT '历史上最多同时存在的线程数',
    `POOL_SIZE`                       int(8)                                                        NULL DEFAULT NULL COMMENT '当前线程总数',
    `CORE_POOL_SIZE`                  int(8)                                                        NULL DEFAULT NULL COMMENT '核心线程数',
    `MAXIMUM_POOL_SIZE`               int(8)                                                        NULL DEFAULT NULL COMMENT '最大线程数',
    `QUEUE_SIZE`                      int(8)                                                        NULL DEFAULT NULL COMMENT '队列大小',
    `REJECTED_TASK_COUNT`             bigint(20)                                                    NULL DEFAULT NULL COMMENT '拒绝的任务数量',
    `REJECTED_EXECUTION_HANDLER_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '拒绝策略名称',
    `QUEUE_REMAINING_CAPACITY`        int(8)                                                        NULL DEFAULT NULL COMMENT '队列剩余容量',
    `QUEUE_TYPE`                      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '队列类型',
    `QUEUE_CAPACITY`                  bigint(20)                                                    NULL DEFAULT NULL COMMENT '队列容量',
    `ALLOW_CORE_THREAD_TIME_OUT`      tinyint(1)                                                    NULL DEFAULT NULL COMMENT '是否允许核心线程超时',
    `KEEP_ALIVE_TIME`                 bigint(20)                                                    NULL DEFAULT NULL COMMENT '空闲线程回收时间（秒）',
    `UTILIZATION_RATE`                double(16, 4)                                                 NULL DEFAULT NULL COMMENT '线程池利用率',
    `INSERT_TIME`                     datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`                     datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    UNIQUE INDEX `UX_INSTANCE_ID_NAME` (`INSTANCE_ID`, `NAME`) USING BTREE COMMENT '索引_应用实例ID_线程池名字',
    INDEX `NX_INSTANCE_ID` (`INSTANCE_ID`) USING BTREE COMMENT '索引_应用实例ID',
    INDEX `NX_NAME` (`NAME`) USING BTREE COMMENT '索引_线程池名字'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'java线程池信息表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_JAVA_THREAD_POOL_HISTORY
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_JAVA_THREAD_POOL_HISTORY`;
CREATE TABLE `MONITOR_JAVA_THREAD_POOL_HISTORY`
(
    `ID`                              bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `INSTANCE_ID`                     varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '应用实例ID',
    `NAME`                            varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '线程池名字',
    ...
    INDEX `NX_INSTANCE_ID` (`INSTANCE_ID`) USING BTREE COMMENT '索引_应用实例ID',
    INDEX `NX_NAME` (`NAME`) USING BTREE COMMENT '索引_线程池名字',
    INDEX `NX_INSERT_TIME` (`INSERT_TIME`) USING BTREE COMMENT '索引_线程池新增时间',
    INDEX `NX_UPDATE_TIME` (`UPDATE_TIME`) USING BTREE COMMENT '索引_线程池更新时间'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'java线程池历史记录表'
  ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for MONITOR_NETWORK_DEVICE
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_NETWORK_DEVICE`;
CREATE TABLE `MONITOR_NETWORK_DEVICE`
(
    `ID`                     bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `IP_SOURCE`              varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT 'IP地址（来源）',
    `IP_TARGET`              varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT 'IP地址（目的地）',
    `CP_NAME`                varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '通信协议',
    `CP_VERSION`             varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT '通信协议版本',
    `CP_PORT`                int                                                           NOT NULL COMMENT '通信端口号',
    `CP_COMMUNITY`           varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '社区字符串',
    `OID`                    longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci     NULL DEFAULT NULL COMMENT 'MIB OID',
    `NETWORK_DEVICE_TYPE`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '网络设备类型',
    `NETWORK_DEVICE_SUMMARY` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '网络设备摘要',
    `IS_ONLINE`              varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '网络设备状态（0：离线，1：在线）',
    `IS_ENABLE_MONITOR`      varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否开启监控（0：不开启监控；1：开启监控）',
    `IS_ENABLE_ALARM`        varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '是否开启告警（0：不开启告警；1：开启告警）',
    `OFFLINE_COUNT`          int                                                           NULL DEFAULT NULL COMMENT '离线次数',
    `CONN_FREQUENCY`         int                                                           NULL DEFAULT NULL COMMENT '连接频率',
    `INSERT_TYPE`            varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NOT NULL COMMENT '新增方式（1：手动新增；2.自动发现）',
    `MONITOR_ENV`            varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控环境',
    `MONITOR_GROUP`          varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控分组',
    `INSERT_TIME`            datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`            datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP_SOURCE` (`IP_SOURCE`) USING BTREE COMMENT '索引_IP地址（来源）',
    UNIQUE INDEX `UX_IP_TARGET` (`IP_TARGET`) USING BTREE COMMENT '索引_IP地址（目的地）',
    INDEX `MONITOR_NETWORK_DEVICE_ENV_FK` (`MONITOR_ENV`) USING BTREE COMMENT '索引_监控环境',
    INDEX `MONITOR_NETWORK_DEVICE_GROUP_FK` (`MONITOR_GROUP`) USING BTREE COMMENT '索引_监控分组',
    CONSTRAINT `MONITOR_NETWORK_DEVICE_ENV_FK` FOREIGN KEY (`MONITOR_ENV`) REFERENCES `MONITOR_ENV` (`ENV_NAME`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `MONITOR_NETWORK_DEVICE_GROUP_FK` FOREIGN KEY (`MONITOR_GROUP`) REFERENCES `MONITOR_GROUP` (`GROUP_NAME`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='网络设备表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_NETWORK_DEVICE_IF
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_NETWORK_DEVICE_IF`;
CREATE TABLE `MONITOR_NETWORK_DEVICE_IF`
(
    `ID`              bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `IP`              varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT 'IP地址',
    `IF_INDEX`        int                                                           NULL DEFAULT NULL COMMENT '网络接口的索引号',
    `IF_DESCR`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '网络接口的描述',
    `IF_TYPE`         varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '网络接口的类型',
    `IF_MTU`          bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络接口的最大传输单元（MTU）',
    `IF_SPEED`        bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络接口的速率（以比特/秒为单位）',
    `IF_PHYS_ADDRESS` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '网络接口的物理地址（MAC地址）',
    `IF_ADMIN_STATUS` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '网络接口的管理状态',
    `IF_OPER_STATUS`  varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '网络接口的操作状态',
    `IF_IN_OCTETS`    bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络接口接收到的字节数',
    `IF_OUT_OCTETS`   bigint(20)                                                    NULL DEFAULT NULL COMMENT '网络接口发送的字节数',
    `INSERT_TIME`     datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`     datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP地址',
    INDEX `NX_IF_INDEX` (`IF_INDEX`) USING BTREE COMMENT '索引_网络接口的索引号',
    INDEX `NX_IP_IF_INDEX` (`IP`, `IF_INDEX`) USING BTREE COMMENT '索引_IP地址_网络接口的索引号'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '网络设备接口表'
  ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for MONITOR_NETWORK_DEVICE_SYS
-- ----------------------------
DROP TABLE IF EXISTS `MONITOR_NETWORK_DEVICE_SYS`;
CREATE TABLE `MONITOR_NETWORK_DEVICE_SYS`
(
    `ID`           bigint(20) UNSIGNED                                           NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `IP`           varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NOT NULL COMMENT 'IP地址',
    `SYS_DESCR`    varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统描述，包含设备的型号、操作系统版本等信息',
    `SYS_UP_TIME`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统自上次重启以来的运行时间（以百分之一秒为单位）',
    `SYS_CONTACT`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统管理员的联系信息',
    `SYS_NAME`     varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统的名称',
    `SYS_LOCATION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统的物理位置',
    `SYS_SERVICES` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '系统提供的服务类型',
    `INSERT_TIME`  datetime                                                      NOT NULL COMMENT '新增时间',
    `UPDATE_TIME`  datetime                                                      NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
    INDEX `NX_IP` (`IP`) USING BTREE COMMENT '索引_IP地址'
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '网络设备系统表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `FAILURE_ALARM_COUNT`              int                                                          NULL DEFAULT NULL COMMENT '故障告警次数',
    `RECOVERY_ALARM_COUNT`             int                                                          NULL DEFAULT NULL COMMENT '恢复告警次数',
    `NEXT_ALLOWED_FAILURE_ALARM_TIME`  datetime                                                     NULL DEFAULT NULL COMMENT '允许的下次故障报警时间',
    `NEXT_ALLOWED_RECOVERY_ALARM_TIME` datetime                                                     NULL DEFAULT NULL COMMENT '允许的下次恢复告警时间',
    `INSERT_TIME`                      datetime                                                     NOT NULL COMMENT '插入时间',
    `UPDATE_TIME`                      datetime                                                     NULL DEFAULT NULL COMMENT '更新时间',
    PRIMARY KEY (`ID`) USING BTREE,
