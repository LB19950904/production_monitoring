...
public class InstanceMonitorJob extends QuartzJobBean implements CommandLineRunner, DisposableBean, IOfflineListener {
    ...
    private void sendAlarmInfo(String title, AlarmLevelEnums alarmLevelEnum, AlarmReasonEnums alarmReasonEnum, MonitorInstance instance) throws NetException {
        ...
        builder.append("应用ID/App ID：").append(instance.getInstanceId())
                .append("，<br>应用名称/App name：").append(instance.getInstanceName());
        // 应用实例描述
        ...
        builder.append("，<br>应用端点/App endpoint：").append(instance.getEndpoint())
                .append("，<br>IP地址/IP address：").append(instance.getIp())
                .append("，<br>时间/Time：").append(DateTimeUtils.dateToString(new Date()));
