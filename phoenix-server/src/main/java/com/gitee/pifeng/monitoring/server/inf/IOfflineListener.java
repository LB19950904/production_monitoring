...
import com.gitee.pifeng.monitoring.server.business.server.websocket.listener.OfflineListener;
...
public interface IOfflineListener {
     ...
     * </p>
     * 此方法在
     * {@link OfflineAspect#beforeWakeUp(JoinPoint)}、
     * {@link OfflineListener#beforeWakeUp(OfflinePackage)}
     * 中被注册监听。
     *
