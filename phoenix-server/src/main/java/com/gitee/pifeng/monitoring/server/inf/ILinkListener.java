...
import com.gitee.pifeng.monitoring.server.business.server.websocket.listener.HeartbeatListener;
import com.gitee.pifeng.monitoring.server.business.server.websocket.listener.ServerListener;
...
public interface ILinkListener {
     ...
     * </p>
     * 此方法在
     * {@link HeartbeatAspect#beforeWakeUp(JoinPoint)}、
     * {@link ServerAspect#beforeWakeUp(JoinPoint)}、
     * {@link HeartbeatListener#beforeWakeUp(HeartbeatPackage)}、
     * {@link ServerListener#beforeWakeUp(ServerPackage)}
     * 中被注册监听。
     *
     * @param param 回调参数
     * @author 皮锋
