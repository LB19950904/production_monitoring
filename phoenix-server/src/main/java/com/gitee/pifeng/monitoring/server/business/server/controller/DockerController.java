...
public class DockerController {
    ...
    /**
     * <p>
     * 监控服务端程序接收监控代理端程序发的docker信息包，并返回结果
     * </p>
     *
     * @param dockerPackage docker信息包
     * @return {@link BaseResponsePackage}
     * @author 皮锋
     * @custom.date 2022年6月24日 下午3:00:54
     */
    @Operation(description = "接收和响应监控代理端程序发的docker信息包", summary = "接收docker信息包",
    ...
    public BaseResponsePackage acceptDockerPackage(@RequestBody DockerPackage dockerPackage) {
        ...
        Result result = this.dockerService.dealDockerPackage(dockerPackage);
