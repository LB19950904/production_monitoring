...
public class TcpMonitorJob extends QuartzJobBean {
    ...
    private MonitoredThreadPoolExecutor tcpMonitorThreadPoolExecutor;
    ...
    private void sendAlarmInfo(String title, AlarmLevelEnums alarmLevelEnum, AlarmReasonEnums alarmReasonEnum, MonitorTcp monitorTcp) throws NetException {
        ...
        builder.append("源主机/From host：").append(monitorTcp.getHostnameSource())
                .append("，<br>目标主机/To host：").append(monitorTcp.getHostnameTarget())
                .append("，<br>目标端口/Target port：").append(monitorTcp.getPortTarget());
        if (StringUtils.isNotBlank(monitorTcp.getDescr())) {
            builder.append("，<br>描述/Desc：").append(monitorTcp.getDescr());
        }
        if (StringUtils.isNotBlank(monitorTcp.getMonitorEnv())) {
            builder.append("，<br>环境/Env：").append(monitorTcp.getMonitorEnv());
        }
        if (StringUtils.isNotBlank(monitorTcp.getMonitorGroup())) {
            builder.append("，<br>分组/Group：").append(monitorTcp.getMonitorGroup());
        }
