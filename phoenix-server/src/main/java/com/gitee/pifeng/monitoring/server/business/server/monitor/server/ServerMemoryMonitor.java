...
@Component
@Slf4j
public class ServerMemoryMonitor implements IServerListener {
    ...
    private void sendAlarmInfo(String title, MonitorServer monitorServer, double menUsedPercent, String menTotal,
        ...
        msgBuilder.append("，<br>内存使用量/Memory usage：").append(menUsed).append(" / ").append(menTotal);
        msgBuilder.append("，<br>内存使用率/Memory usage：").append(menUsedPercent).append("%");
