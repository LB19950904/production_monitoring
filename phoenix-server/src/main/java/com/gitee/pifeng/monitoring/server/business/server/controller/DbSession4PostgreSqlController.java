...
import com.gitee.pifeng.monitoring.server.business.server.service.IDbSession4PostgreSqlService;
...
public class DbSession4PostgreSqlController {
    ...
    public BaseResponsePackage getSessionList(@RequestBody BaseRequestPackage baseRequestPackage) throws SQLException {
        ...
        List<Entity> entities = this.dbSession4PostgreSqlService.getSessionList(url, username, password);
    ...
    public BaseResponsePackage destroySession(@RequestBody BaseRequestPackage baseRequestPackage) throws SQLException {
        ...
        this.dbSession4PostgreSqlService.destroySession(url, username, password, sessionIds);
