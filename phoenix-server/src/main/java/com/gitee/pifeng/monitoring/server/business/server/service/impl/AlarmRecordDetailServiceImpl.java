        ...
        for (AlarmWayEnums alarmWayEnum : alarmWayEnums) {
            ...
            switch (alarmWayEnum) {
                ...
                case DINGTALK:
                    ...
                    Boolean isDingtalkAtAll = dingtalkProperties.getIsAtAll();
                    String[] dingtalkPhones = dingtalkProperties.getPhoneNumbers();
                    String dingtalkPhonesStr = StringUtils.join(dingtalkPhones, ",");
                    monitorAlarmRecordDetail.setNumber(isDingtalkAtAll ? "所有人" : dingtalkPhonesStr);
                    break;
                case EPWECHAT:
                    ...
                    Boolean isEnterpriseWechatAtAll = enterpriseWechatProperties.getIsAtAll();
                    String[] enterpriseWechatPhones = enterpriseWechatProperties.getPhoneNumbers();
                    String enterpriseWechatPhonesStr = StringUtils.join(enterpriseWechatPhones, ",");
                    monitorAlarmRecordDetail.setNumber(isEnterpriseWechatAtAll ? "所有人" : enterpriseWechatPhonesStr);
                    break;
                case FEISHU:
                    ...
                    Boolean isFeishuAtAll = feishuProperties.getIsAtAll();
                    String[] userIds = feishuProperties.getUserIds();
                    String userIdsStr = StringUtils.join(userIds, ",");
                    monitorAlarmRecordDetail.setNumber(isFeishuAtAll ? "所有人" : userIdsStr);
                    break;
                default:
                    // 其它情况直接结束
                    break;
